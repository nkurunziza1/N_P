...
import { handleCreation, handlegetAllUsers } from '@/components/api/client';
import { UsersType } from '@/components/utility/types/types';
    ...
    return (
        <div>
                                ...
                                <Form className="space-y-5">
                                    ...
                                    <div className="grid grid-cols-1 gap-5 md:grid-cols-4">
                                        <div className={`md:col-span-2 ${submitCount ? (errors.phoneNumber ? 'has-error' : 'has-success') : ''}`}>
                                            ...
                                            {submitCount ? errors.phoneNumber ? <div className="mt-1 text-danger">{errors.phoneNumber}</div> : <div className="mt-1 text-success">Looks Good!</div> : ''}
                                        </div>
            ...
            <div className="panel flex items-center justify-between overflow-x-auto whitespace-nowrap p-3 text-primary">
                ...
                <Button className='bg-primary' onClick={showModel}>Register client  +</Button>
            </div>
            <div className="panel mt-6">
                <div className="mb-5 flex flex-col gap-5 md:flex-row md:items-center">
                    <h5 className="text-lg font-semibold dark:text-white-light uppercase"> List of Clients</h5>
